...
def get_logging_dict_config(
    ...
    mail_from_addr: str | None = None,
    mail_to_addr: str | list[str] | None = None,
    ...
    -------
    dict
        dictionary with logger configuration for the method
    ...
    return dict(
        ...
        loggers={"": dict(level="NOTSET", handlers=handlers_names)},
        handlers=handlers,
        formatters={
            "info": {
                "format": (
